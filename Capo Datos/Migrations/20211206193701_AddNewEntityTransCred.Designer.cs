...
namespace Capo_Datos.Migrations
{
    ...
    [Migration("20211206193701_AddNewEntityTransCred")]
    partial class AddNewEntityTransCred
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entidades.TransferenciaCredito", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("Id_CreditoOrigen")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("Id_CreditoOrigen");

                    b.HasIndex("Id_CuentaDestino");

                    b.ToTable("TransferenciasCredito");
                });
            ...
            modelBuilder.Entity("Entidades.TransferenciaCuenta", b =>
                {
                    ...
                    b.ToTable("TransferenciasCuenta");
                });
            ...
            modelBuilder.Entity("Entidades.TransferenciaCredito", b =>
                {
                    b.HasOne("Entidades.TarjetaCredito", "TarjetaCredito")
                        .WithMany()
                        .HasForeignKey("Id_CreditoOrigen")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
