        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Codg_Cuenta = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Balance_Actual = table.Column<double>(type: "float", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CuentasAhorro", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CuentasAhorro_AspNetUsers_Id_Usuario",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EstadoCuentas_CuentasAhorro_Id_cuenta",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CuentasAhorro_Id_Usuario",
                table: "CuentasAhorro",
                column: "Id_Usuario");

            migrationBuilder.CreateIndex(
                name: "IX_EstadoCuentas_Id_cuenta",
                table: "EstadoCuentas",
                column: "Id_cuenta");
        }
